...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_logged.setGeometry(QtCore.QRect(300, 100, 301, 41))
        self.label_logged.setAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"}")
        ...
        self.current_admin.setGeometry(QtCore.QRect(270, 180, 351, 41))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"text-align : center;")
        ...
        self.current_rank.setGeometry(QtCore.QRect(300, 250, 301, 41))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"}")
        ...
        self.use_app_user_fname_label = QtWidgets.QLabel(self.use_app_user_info_panel)
        self.use_app_user_fname_label.setGeometry(QtCore.QRect(70, 280, 131, 31))
        self.use_app_user_fname_label.setObjectName("use_app_user_fname_label")
        self.use_app_user_fname_label.setFont(font)
        self.use_app_user_lname_label = QtWidgets.QLabel(self.use_app_user_info_panel)
        self.use_app_user_lname_label.setGeometry(QtCore.QRect(70, 320, 131, 31))
        self.use_app_user_lname_label.setObjectName("use_app_user_lname_label")
        self.use_app_user_lname_label.setFont(font)
        self.use_app_user_rank_label = QtWidgets.QLabel(self.use_app_user_info_panel)
        self.use_app_user_rank_label.setGeometry(QtCore.QRect(70, 360, 131, 31))
        self.use_app_user_rank_label.setObjectName("use_app_user_rank_label")
        self.use_app_user_rank_label.setFont(font)
        self.use_app_user_image_label = QtWidgets.QLabel(self.use_app_user_info_panel)
        self.use_app_user_image_label.setGeometry(QtCore.QRect(70, 130, 141, 141))
...
"}")
    ...
    def deleteUser(self):
        ...
        try:
            ...
            self.error_label_2.setText(res)
            self.error_label_2.setStyleSheet("color:rgba(149, 1, 60,0.9)")
            print(res)
...
"delete an account !"))
        ...
        self.use_app_user_fname_label.setText(_translate("MainWindow", "First Name"))
        self.use_app_user_lname_label.setText(_translate("MainWindow", "Last Name"))
        self.use_app_user_rank_label.setText(_translate("MainWindow", "Rank"))
